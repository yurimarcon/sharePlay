			...
			<style type="text/css">
								...
								<ul>
									...
									<?php 
										if(isset($_SESSION['email'])){
											echo	'<li class="current">><a href="MeusDados.php">Meus dados</a></li>'.
				...
				<div class="container py-5">
						  ...
						  <div class="card-body">
						    ...
						    <form method="POST" action="scripts/atualizaCadastro.php">
							  ...
							  <div class="form-row">
							    ...
							    <div class="form-group col-md-6">
							      ...
							      <select id="inputUF" value="<?php if($_SESSION['uf']) echo $_SESSION['uf'] ?>" name="uf" class="form-control">
							        <option selected><?php if($_SESSION && $_SESSION['uf']){echo $_SESSION['uf'];}else{ echo 'Selecione...';} ?></option>
